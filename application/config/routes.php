...
$route['editstatus/(:any)'] = 'produk/editstatus/$1';
$route['statushapus/(:any)'] = 'produk/hapusstatus/$1';


$route['kategori'] = 'produk/kategori';
$route['editkategori/(:any)'] = 'produk/editkategori/$1';
$route['kategorihapus/(:any)'] = 'produk/hapuskategori/$1';

$route['tambah'] = 'produk/tambahproduk';
